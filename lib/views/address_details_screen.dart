...
/*
  ...
  fetchAddress(bool firstLoad) async {
    ...
    var response =
        await helper.postAPI('users/all-address', requestModel, context);
  ...
  fetchCenterManagement() async {
    ...
    var response = await helper.postAPI(
        'center_management/allCenterManagement', requestModel, context);
  ...
  placeOrder() async {
    ...
    ApiBaseHelper helper = ApiBaseHelper();
    var response = await helper.postAPI(
        'order-management/OrderByNow', requestModel, context);
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            keyboardType: isDatePicker
                ? TextInputType.none
                : TextInputType.text, // Disable keyboard for date picker
            onTap: isDatePicker
                ? () async {
                    if (onTap != null) {
