...
class NewClientFormScreen extends StatefulWidget {
  const NewClientFormScreen({super.key});

  @override
  State<NewClientFormScreen> createState() => _NewClientFormScreenState();
}

class _NewClientFormScreenState extends State<NewClientFormScreen> {
  DateTime? selectedDate;
  int selectedServiceIndex = 0;
  String selectedServiceDrop = "";
  bool secondService = false;
  String selectedwayName = 'way Name';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            // final bool isValid =
                            //     await FlutterNumberCaptcha.show(
                            //   context,
                            //   titleText: 'Enter the correct number',
  ...
  void waysBottomSheet(BuildContext context) {
