...
import 'package:vedic_health/views/practitioner/practitioner_product_details.dart';
import 'package:vedic_health/widgets/pract_custom_appbar_widget.dart';
...
class PractitionerProductScreen extends StatefulWidget{
  _practitionerScreen createState()=>_practitionerScreen();
}
class _practitionerScreen extends State<PractitionerProductScreen>{
  String? userName;
  String? userId;
  int selectedIndex = 0;
        ...
        child:  Scaffold(
          ...
          appBar: PractCustomAppBar
            (title: "Product",
              ...
              actionIconStr: "assets/cart_bag.png",
              onAction: (){
                Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  isLoading ? Container() : SizedBox(height: 25),
                  isLoading
                      ? Container()
                      : Container(
                      height: 89,
                        ...
                        return GestureDetector(
                          onTap: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => PractitionerProductDetailsScreen(productId, categoryId)));
                          },
                          child: Container(
