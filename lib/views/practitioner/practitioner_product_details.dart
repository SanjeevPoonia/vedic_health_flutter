...
class PractitionerProductDetailsScreen extends StatefulWidget{
  final String productID;
  final String catID;

  PractitionerProductDetailsScreen(this.productID, this.catID);
  _practitionerProductDetails createState()=>_practitionerProductDetails();
}
class _practitionerProductDetails extends State<PractitionerProductDetailsScreen>{
  double rating = 3.5;
  int starCount = 5;
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                                builder: (context) => PractitionerProductDetailsScreen(
                                              ...
                                              child: Row(
                                                children: [
                                                  Text(
                                                      ...
                                                      "\$${similarProducts[index]["price"]?.toString()??""}",
          ...
          if(da['createdCartManagement']!=null){
            ...
            /*if(quantity<2){
              ...
              Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => PractitionerCartDetails()));
            }*/
            Navigator.push(
                context,
                MaterialPageRoute(
  ...
  placeOrder(String cartId) async {
    ...
    //Navigator.push(context, MaterialPageRoute(builder: (context)=>AddressScreen(cartIDs,productData["discounted_price"]?.toString()??productData["price"]?.toString()??"")));
    setState(() {});
  }
